...
# ╔═╡ adf21348-d525-11ee-3f99-ad3096543cd8
begin
	using Plots
	using MAT
	using Glob
...
# ╔═╡ 06864a0d-b731-48c4-b705-53325604ae35
begin
	# --loop setup
		B_SNRs = [0.0];
		W_SNRs = [0.0];
	...
	# --Load in mat files
		mat_file = glob("Raw Data/Cubic Kernel Results/*.mat");
		size(mat_file,1)
...
# ╔═╡ c5aba87b-f003-4770-8e71-22ac80f36341
begin
