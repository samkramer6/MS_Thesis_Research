...
begin
	# --Creating Noisy Signal
		alpha = 2;
		rand_values = alpha .* vec(rand(Normal(0, 0.3), 1, length(time_long)));
...
begin
	...
	xcorr_plot = plot(xcorr_example ./ maximum(xcorr_example),
					guidefont = (10, "Computer Modern"),
					tickfont = ("Computer Modern"),
					xlabel = "Lags (\\tau)",
					ylabel = "Amplitude",
...
begin
	...
	kcc_plot = plot(kcc_corr./maximum(kcc_corr),
					guidefont = (10, "Computer Modern"),
					titlefont = ("Computer Modern"),
					tickfont = ("Computer Modern"),
					xlabel = "Lags (\\tau)",
...
manifest_format = "2.0"
project_hash = "a709c55f07d1945db0ee3416eeb81ecddb49d812"
