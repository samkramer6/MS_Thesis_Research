...
md"# Notebook 3: Matched Filter Detection Simulation Results

This notebook will be used to conglomerate all the matched filter detection results, plot it, and then output it again as a new .mat file.
...
begin
	...
	# --Load in mat files
		mat_file = glob("Raw Data/Matched Filter Results/*.mat");
		size(mat_file,1)
...
begin
	pB = scatter(B_SNRs, B_detection, 
		xlabel = "SNR (dB)", 
		label = false, 
		title = "Matched Filter Probability of Detection in Brownian Noise",
	...
	pW = scatter(W_SNRs, W_detection, 
		label = false, 
		title = "Matched Filter Probability of Detection in White Noise",
		titlefont = (12, "Computer Modern"),
		guidefont = (9, "Computer Modern"),
		xtickfont = (7, "Computer Modern"),
		xticks = -40:2:0,
